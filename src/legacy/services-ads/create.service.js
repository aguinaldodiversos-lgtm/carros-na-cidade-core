/**
 * @deprecated LEGADO — isolado em `src/legacy/services-ads`.
 * Não executável no monorepo atual (require → módulos ESM). Só referência histórica.
 *
 * Oficial: `createAdNormalized` em `src/modules/ads/ads.create.pipeline.service.js`.
 */
const pool = require("../../config/db");
const slugify = require("../../utils/slugify");

async function createAd(advertiser, data) {
  const { title, price, city, state, latitude, longitude } = data;
