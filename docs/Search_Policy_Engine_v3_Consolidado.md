...
**Data:** 2026-09-09
**Última sincronização normativa:** 2026-09-21
...
**Fontes:** `docs/Search_Policy_Decisions_2026-09.md` @ 893c0f39 (DEC-01…DEC-15, DEC-17…DEC-25, ADI-01…ADI-03, MET-01), DEC-26 (2026-09-20) e DEC-27 (2026-09-21) · `docs/history/Search_Policy_Engine_v2_Apos_Auditoria.md` (histórico, não normativo). Por DEC-25, `docs/F2_GATE_SQL.md` @ 978c6715 deixou de ser fonte normativa e permanece apenas como evidência histórica.
...
| V3-INV-009 | Filtro explícito de produto não provoca expansão territorial silenciosa                                                                                                                                                                                                                                                              | DEC-10 · DEC-18            |
...
**Contagem.** IDs `V3-INV` alocados: **78**. Retirados: **3** — `V3-INV-029`, `V3-INV-031` e `V3-INV-040`. Invariantes normativos ativos: **75**. DEC-26 **não** criou invariante novo: refinou o enunciado e a proveniência de `V3-INV-012`, `V3-INV-013`, `V3-INV-061`, `V3-INV-062`, `V3-INV-063` e `V3-INV-066`, que continuam representando as mesmas obrigações sob os mesmos IDs, e por isso o total de ativos permanece **75**. DEC-27 também **não** criou invariante novo. `V3-INV-052` preserva o mesmo ID porque continua governando o contrato mínimo do único evento obrigatório de telemetria; DEC-27 corrige quais grandezas pertencem semanticamente ao nível da busca, reduzindo esse mínimo de 14 para 11 grandezas, e reformula o enunciado e a proveniência do invariante. O total de ativos permanece **75**. Um ID retirado permanece reservado para rastreabilidade e nunca é reutilizado por outro requisito, do mesmo modo que a lacuna deliberada do DEC-16 no registro de decisões.
