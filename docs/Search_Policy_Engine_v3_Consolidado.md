...
**Data:** 2026-09-09
**Última sincronização normativa:** 2026-09-24
...
**Certificação do delta DEC-27:** CERTIFICADA em 2026-09-21 sobre o delta documental `d4e4ba7d → deb928bc`, por auditoria documental independente em air-gap, com `HASHES_VALID = SIM`, `INDEPENDENCE_GATE = PASS`, zero mudanças normativas fora do escopo e zero contradições normativas. Relatório SHA-256 `9dccf84a9acec199c8b3ee53760118e172bb599a8539a09b923a22659570658d`. A certificação cobre exclusivamente o delta normativo documental; não certifica código, implementação, banco de produção, runtime ou deploy. Não substitui nem reescreve as certificações MET-01 e DEC-26.
**Delta DEC-28/DEC-29:** NÃO CERTIFICADO — sincronizado em 2026-09-24, corrigido em 2026-09-24 após pré-auditoria documental e endurecido em 2026-09-24, em duas rodadas, após as auditorias air-gap que o reprovaram (território: seções 4, 5, 6, 7, 8, 9, 12, 14, 17, 18 e 23.a, invariantes `V3-INV-005`, `V3-INV-008`, `V3-INV-009`, `V3-INV-039`, `V3-INV-047`, `V3-INV-053`, `V3-INV-066` e `V3-INV-079`…`V3-INV-090`). É conteúdo normativo posterior ao delta certificado em `deb928bc` e, pela governança registrada abaixo, constitui delta não certificado até que uma auditoria documental própria o cubra. Não altera as certificações MET-01, DEC-26 e DEC-27, que continuam valendo apenas para os baselines que certificaram.
**Fontes:** `docs/Search_Policy_Decisions_2026-09.md` @ 893c0f39 (DEC-01…DEC-15, DEC-17…DEC-25, ADI-01…ADI-03, MET-01), DEC-26 (2026-09-20), DEC-27 (2026-09-21), DEC-28 e DEC-29 (2026-09-23) · `docs/history/Search_Policy_Engine_v2_Apos_Auditoria.md` (histórico, não normativo). Por DEC-25, `docs/F2_GATE_SQL.md` @ 978c6715 deixou de ser fonte normativa e permanece apenas como evidência histórica.
...
>
> **Governança do delta pós-certificação.** A certificação MET-01 acima permanece válida **para o baseline que certificou** e não é retroativa ao conteúdo acrescentado depois dele. A sincronização de DEC-26, feita em 2026-09-20, é conteúdo normativo posterior e por isso exigiu auditoria documental própria, que foi realizada em air-gap e em duas etapas — `2d3913ec → 96cd99e5` e `96cd99e5 → 6981b73d` —, ambas aprovadas. Com ela, o estado normativo deste documento até o baseline `6981b73d` está documentalmente certificado. A DEC-27, posterior ao baseline certificado de DEC-26, foi auditada documentalmente de forma independente sobre `d4e4ba7d → deb928bc` e aprovada sem blockers. Com essa auditoria, o estado normativo deste documento até `deb928bc` está documentalmente certificado. Qualquer mudança normativa posterior a `deb928bc` volta a constituir delta não certificado até que nova auditoria própria a cubra. A cadeia de certificação é, portanto: MET-01 certificada no próprio baseline `48f7e9ed`; DEC-26 certificada até `6981b73d`; DEC-27 certificada até `deb928bc`; DEC-28 e DEC-29, sincronizadas em 2026-09-24, ainda não certificadas; mudança normativa posterior, também não certificada. Nenhuma dessas certificações documentais cobre implementação ou runtime.
...
A política pode calcular um **Specificity Score** a partir das dimensões de produto presentes (marca, modelo comercial, versão, ano, preço, carroceria, câmbio, combustível). Quanto maior a especificidade, menor o alvo de liquidez necessário. O objetivo é dispensar regras especiais por veículo. _Delimitação por DEC-28: a gradação vale **dentro** da família de busca de produto específico — SEARCH_MODEL 24, SEARCH_MODEL_YEAR 16, SEARCH_VERSION 12 —, e não entre essa família e os perfis de navegação. Comparado a BROWSE_CITY 20 e SEARCH_BRAND 16, o alvo de SEARCH_MODEL é deliberadamente maior, porque uma busca por modelo com catálogo pobre precisa de território maior para ter o que mostrar. A regra geral continua sendo a de cima; a exceção é esta, e é transitória._
...
**Menor território útil.** Em modo automático, o motor deve escolher o menor território capaz de atingir o alvo de liquidez do perfil. Nunca o maior possível, e nunca um degrau acima do necessário. _Conflito: DEC-04, v2.0 §16 e `V3-INV-005` exigem o menor território necessário, enquanto DEC-28 impõe o baseline de descoberta como piso e DEC-29 impõe o piso regional, os dois capazes de produzir território maior que o necessário. Vale DEC-28 e DEC-29: "menor território" passa a significar **o menor a partir do piso** — o motor não sobe um degrau acima do necessário, mas também não desce abaixo do piso._

**A liquidez que decide é a da busca, não a da cidade.** O alvo avaliado é o do perfil em jogo, sobre a liquidez **já filtrada** pelas dimensões de produto ativas. A liquidez sem filtro serve ao território-base de descoberta (seção 8), que é piso, nunca teto. Uma origem com muito estoque próprio de outros modelos não pode, por isso, encolher o território de quem procura um modelo específico. _Refina DEC-18, cuja última frase vinha sendo lida como teto._

**Piso regional.** Todo território automático parte de um raio mínimo — inicialmente 25 km —, qualquer que seja o perfil e mesmo quando a liquidez local já atinge o alvo. Como a malha de distâncias é simétrica, o piso torna a vizinhança recíproca: se B está dentro do piso de A, os anúncios de B aparecem na página de A e os de A na de B, sem depender de qual das duas tem mais estoque. O piso é mínimo do modo automático; raio explícito, inclusive 0, continua vencendo (seções 4 e 7).
...
**`required_distance_km` e `effective_radius_km` são grandezas distintas.** O conjunto final deve incluir **todos** os candidatos elegíveis dentro do território consultado, e não apenas as cidades estritamente necessárias para alcançar matematicamente o alvo. As duas grandezas são semanticamente distintas e não devem ser confundidas uma com a outra; DEC-20 estabelece a distinção, não uma obrigação de telemetria (seção 16). Os anéis são política e UX; `distance_km` continua sendo a verdade geográfica. Em `MANUAL_RADIUS` não há conversão para anel: o raio exato solicitado é o raio efetivo. _Conflito: DEC-20 descrevia o `effective_radius_km` como produto da conversão do `required_distance_km` para o menor anel que o contenha. Com o piso, o território consultado é o maior entre piso, baseline e AUTO do perfil, e pode conter candidatos além desse anel. Vale DEC-28 e DEC-29: o `effective_radius_km` publicado é o menor anel que contém o **conjunto final** (`V3-INV-081`), e a conversão de DEC-20 descreve apenas a contribuição do perfil ao território consultado._

**Território consultado e território declarado.** São dois números e o documento os distingue por nome. O **consultado** é o raio de que o motor extraiu candidatos: o maior entre o piso regional, o território-base de descoberta e o AUTO do perfil. O **declarado** é o `effective_radius_km`, o menor anel que contém o conjunto final, e é o único que a página mostra e a telemetria publica. Onde o restante deste documento diz "raio efetivo" sem qualificar, entende-se o declarado. Uma busca cujos candidatos estão todos na origem declara 0 km mesmo tendo consultado 25.
...
| `SEARCH_BRAND`      |           16 |
| `SEARCH_MODEL`      |           24 |
| `SEARCH_MODEL_YEAR` |           16 |
| `SEARCH_VERSION`    |           12 |

_Conflito: v2.0 §19 sugere faixas mais altas (24–40 para "qualquer veículo", 20–24 para carroceria, 16–20 para marca, 12–16 para modelo, 8–12 para modelo + ano, 4–8 para versão + ano); DEC-17 fixa valores abaixo dessa faixa. Vale DEC-17._ _DEC-28 ajusta os três perfis de produto específico para 24, 16 e 12, preservando a gradação **entre eles**; os demais seguem como DEC-17 os fixou. Entre famílias a gradação da seção 5 não se aplica: SEARCH_MODEL 24 fica acima de BROWSE_CITY 20 e de SEARCH_BRAND 16, deliberadamente. O caráter transitório e o gatilho de revisão continuam valendo, e com catálogo pobre esses alvos levam a busca de modelo ao teto automático com frequência — isso é deliberado enquanto durar a formação de estoque._ Os alvos menores de DEC-17 para os perfis de navegação são deliberados pelo motivo inverso: com o estoque atual, alvos maiores levariam toda navegação ao raio máximo e destruiriam a territorialidade. As duas escolhas convivem porque tratam de casos diferentes — navegar uma cidade não é procurar um modelo. A revisão é disparada por telemetria de `search.executed` indicando catálogo pobre no raio inicial, ou por estoque em uma origem piloto suficiente para sustentar alvos maiores. O princípio de configurabilidade da v2.0 §19 permanece; apenas os números mudam. A decisão é declarada transitória.
...
**O raio declarado descreve o conjunto, não a consulta.** O `effective_radius_km` publicado deve ser o menor anel que contém integralmente o conjunto final de candidatos. Território consultado maior — por piso regional ou por baseline — não é território declarado: uma busca cujos candidatos estão todos na própria cidade declara 0 km, ainda que o piso tenha consultado 25. É a mesma regra do parágrafo anterior, aplicada também quando o alvo **é** atingido.

**Proveniência:** DEC-03 · DEC-04 · DEC-11 · DEC-17 · DEC-20 · DEC-23 · DEC-25 · DEC-28 · DEC-29 · gate D5 (evidência) · v2.0 §16 · v2.0 §18 · v2.0 §19 · v2.0 §56.

---

## 7. Comportamento inicial da página territorial

A rota `/carros-em/[cidade]` deve nascer no perfil `BROWSE_CITY` em modo `AUTO_RADIUS`. O automático escolhe o menor território que atinge liquidez útil, partindo do piso regional (seção 6): quando a liquidez **dentro do piso** já atinge o alvo, o território consultado fica no piso; caso contrário, expande pelos anéis automáticos acima do piso, parando no primeiro que atinge o alvo. Com o piso inicial de 25 km, esses anéis são 50 e 75 km; o piso é parâmetro de política (DEC-29), e quem define a sequência é ele, não a lista fixa.

_Refina DEC-03 por DEC-29: o território **consultado** nunca é 0 km em modo automático, porque o piso é mínimo. O raio **declarado** continua podendo ser 0 — é o que acontece quando o conjunto final está todo na própria cidade —, e o 0 km explícito continua existindo como escolha manual._
...
**Proveniência:** DEC-03 · DEC-05 · DEC-24 · DEC-29 · v2.0 §12 · v2.0 §13.
...
2. calcular o território automático do **perfil de produto em jogo**, sobre a liquidez já filtrada, com o alvo e o teto automático desse perfil (seção 6);
3. adotar o **maior** entre o piso regional, o baseline e o território do perfil;
4. se o resultado ainda ficar abaixo do alvo do perfil, entrar em Guided Relaxation (seção 9).

O baseline é **piso, não teto**: ele garante um território mínimo de descoberta e nunca encolhe a busca de produto. Acima do teto automático do perfil o motor não expande sozinho — 150 km permanece concessão (seção 9).

_Conflito: DEC-18 encerra dizendo que "o sistema não amplia silenciosamente além do baseline", o que vinha sendo lido como teto; DEC-28 supera essa frase e mantém o restante. Vale DEC-28._ Lida como teto, a regra invertia o princípio do menor território útil: quanto mais estoque próprio a origem tinha, menor o território da busca de produto, porque o baseline era satisfeito a 0 km por anúncios sem relação com a busca. Caso observado em produção: origem com 33 anúncios próprios e 3 do modelo procurado não enxergava o quarto anúncio do mesmo modelo a 18,34 km, enquanto a vizinha com 1 anúncio próprio via os quatro.
...
**Proveniência:** DEC-05 · DEC-18 · DEC-24 · DEC-28 · DEC-29 · v2.0 §12 · v2.0 §14 · v2.0 §15.
...
- **distância** — a menor distância real que acrescenta resultados acima do território **consultado**, arredondada para cima ao quantum configurado e limitada a 150 km; o acréscimo que classifica a banda de custo também se mede contra o território consultado — incluído o piso regional —, nunca contra o raio declarado, que descreve só o conjunto encontrado (DEC-28, DEC-29): com piso 25 km e declarado 0 km, uma concessão a 30 km é acréscimo de 5 km, banda `PEQUENA`, porque tudo abaixo de 25 km já fora consultado e nada havia ali; _Conflito: DEC-21 formulava esta dimensão como "o primeiro anel permitido acima do território atual que acrescenta resultados". DEC-26 a supera: a concessão territorial não depende de presets de `rings_manual` e não existe lista normativa obrigatória de anéis de concessão. Vale DEC-26._
- **câmbio** — a remoção da restrição, quando isso acrescentar candidatos.

**Boundary real, nunca degrau cego.** A concessão de cada dimensão parte do valor real que o estoque revela — o menor novo teto, o próximo ano existente, o menor limite de quilometragem útil, a distância do primeiro candidato externo útil — e não de um percentual ou decremento aplicado às cegas. Ficam superados como política vigente preço +15% fixo, ano −2 fixo, quilometragem +25% fixa e "próximo anel" de distância quando esse anel não acrescenta resultados (DEC-26).

**Arredondamento.** Onde há quantum, o arredondamento é sempre **para cima** a partir do boundary real, e o valor arredondado é ao mesmo tempo o valor aplicado, o transportado na URL e o exibido ao usuário — os três são o mesmo número. Arredondar para baixo é proibido quando isso excluir o candidato que justificou a concessão (DEC-26; v2.0 §52, que exige que a página não apresente algo diferente do que o motor faz). A banda de custo é classificada **depois** desse arredondamento, sobre o valor final aplicado, e nunca sobre o boundary bruto: boundary real → arredondamento para cima pelo quantum da dimensão → valor final aplicado, transportado na URL e exibido → variação efetiva contra o limite atual → banda. Quando o arredondamento cruza uma fronteira de banda, vale a banda do valor final, porque é essa a concessão que o usuário realmente aceita: teto de R$ 100.000 com boundary útil em R$ 104.800 e quantum de R$ 1.000 produz R$ 105.000, +5%, banda `PEQUENA`; se produzisse R$ 106.000, seria +6% e banda `MEDIA`. O mesmo vale para quilometragem — 50.000 km com boundary útil em 59.200 km e quantum de 5.000 km produz 60.000 km, acréscimo efetivo de 10.000 km, banda `PEQUENA` — e para distância, como mostra o exemplo da concessão de 38,1 km para 40 km. Ano não tem quantum e não sofre essa distinção; câmbio é `GRANDE` por definição qualitativa (DEC-26).

**Elegibilidade mínima.** Uma concessão é oferecível quando acrescenta pelo menos um resultado; esta versão da política não exige mais do que isso, e o delta zero continua oculto por DEC-14 (DEC-26).

**Leveza operacional.** A busca normal não investiga automaticamente até 150 km: monta o conjunto no território atual e encerra quando o alvo é atingido. Só quando a Guided Relaxation é necessária a dimensão de distância pode investigar até 150 km. A investigação ampliada é sob demanda e não se torna custo permanente de toda busca (DEC-26).
...
**O custo é uma banda ordinal.** DEC-26 fixa o custo de cada concessão como uma classe — `PEQUENA`, `MEDIA` ou `GRANDE` —, e não como peso contínuo entre dimensões incomparáveis. A comparação de custo é categórica: uma concessão de banda menor **nunca** perde para uma de banda maior apenas por acrescentar mais resultados. É o que torna estrutural, e não dependente de calibração, a proibição de que a ampliação de 25 km para 150 km vença uma pequena concessão de preço, ano ou quilometragem.

**Ordem de decisão.** Nesta ordem: menor banda de custo; maior número de resultados acrescentados; maior número de vendedores acrescentados; maior número de cidades acrescentadas; e, por último, uma ordem de prioridade determinística. O número de resultados acrescentados é o benefício principal; vendedores e cidades são desempates sucessivos e **não** compõem um score contínuo nesta versão. A ordem de prioridade determinística existe apenas para estabilizar empates e não pode superar banda de custo nem benefício. Sua configuração inicial é `price`, `year`, `mileage`, `radius`, `transmission` (DEC-26).

**Valores da política.** _Conflito: DEC-21 deixou pesos, custos por dimensão e quantums de arredondamento como `pendente` e proibiu supri-los por invenção; DEC-26 os fixa por decisão do dono do produto. Vale DEC-26._ Os valores iniciais são: preço `PEQUENA` até +5%, `MEDIA` acima de 5% e até 10%, `GRANDE` acima de 10%, quantum R$ 1.000; ano `PEQUENA` 1, `MEDIA` 2, `GRANDE` 3 ou mais, sem quantum; quilometragem `PEQUENA` até +10.000 km, `MEDIA` acima de 10.000 e até 25.000 km, `GRANDE` acima de 25.000 km, quantum 5.000 km; distância `PEQUENA` até +25 km, `MEDIA` acima de 25 e até 50 km, `GRANDE` acima de 50 km, quantum 5 km e teto de 150 km; câmbio `GRANDE`; delta mínimo de 1 resultado. São parâmetros iniciais versionados de política, representáveis em configuração, não constantes permanentes do produto: podem ser recalibrados com telemetria mediante **nova** decisão normativa, e até lá valem os aqui fixados. O que é estrutural e não depende de recalibração: as bandas de custo, a ordem de decisão, o boundary real, o arredondamento para cima, o teto de 150 km e a cadeia de desempates.
...
**Proveniência:** DEC-10 · DEC-11 · DEC-12 · DEC-14 · DEC-21 · DEC-23 · DEC-25 · DEC-26 · gate D4 (evidência) · gate D8 (evidência) · v2.0 §17 · v2.0 §18 · v2.0 §28 · v2.0 §52 · `pendente` (recalibração futura dos valores da política, que depende de telemetria e de nova decisão; a política inicial está decidida por DEC-26).
...
**Forma do escopo.** O território é, conceitualmente, o conjunto de cidades elegíveis derivado de `region_memberships` pela regra de distância aplicável — `distance_km <= raio`, a verdade funcional da inclusão —, e esse mesmo conjunto deve ser compartilhado por todas as consultas do ciclo (grid, contagem, facetas e relaxações). DEC-25 ratifica **o princípio** da proposta do gate D3 pela via de DEC-08: a unicidade do escopo é norma; a forma técnica de representá-lo e de passá-lo às consultas — SQL, conjunto explícito, subconsulta ou qualquer outro transporte — é implementação, não norma. O gate D3 (evidência) mediu 82 cidades para 75 km e 223 para 150 km a partir de uma origem piloto — número útil para dimensionamento, não regra.
...
O pipeline de ranking deve ser, nesta ordem: status e disponibilidade; correspondência com o produto; elegibilidade territorial; peso comercial decrescente; teto de participação por cidade, agindo **dentro** de cada faixa de peso (DEC-29); distância crescente; rotação e diversidade entre vendedores (quando ativadas — ADI-02); qualidade e recência; desempate determinístico final. O teto é a única etapa de diversidade vigente nesta fase, e é por isso que ele aparece antes da distância: a diversidade entre vendedores da v2.0 §35, que agiria depois dela, continua adiada.
...
**Peso vence distância; distância organiza o mesmo peso.** Entre anúncios territorialmente elegíveis, o peso comercial decide a prioridade; a distância só ordena entre anúncios de mesmo peso, ressalvado o adiamento do teto de participação por cidade, que age dentro da faixa (DEC-29, abaixo). A cidade-base não tem prioridade absoluta: ela vence naturalmente por distância quando o peso é igual.
...
**Teto de participação por cidade.** **Dentro de uma mesma faixa de peso comercial**, nenhuma cidade diferente da origem deve ocupar mais que a fração configurada da **capacidade daquela faixa na página** — inicialmente 40%. A capacidade é o menor entre o tamanho da página e o número de candidatos daquela faixa no CandidateScope, nunca menor que 1. A base é a faixa, e não a página inteira: numa página de 24 vagas cuja faixa Destaque tem 10 candidatos, o teto de uma cidade externa naquela faixa é 4, e não 9. Também não são as vagas que a faixa acabou ocupando na página: essas dependem da ordenação, que depende do teto, e o critério mediria o resultado contra ele mesmo. Por consequência, uma cidade externa que domine uma faixa sem concorrente da mesma faixa pode ultrapassar 40% da página, e isso é consequência aceita (DEC-29), porque o teto distribui o que existe e nunca rebaixa anúncio pago para fabricar diversidade. O teto age **depois** do peso comercial e antes da distância: dentro de uma faixa ele diversifica; entre faixas, quem manda é o peso. Isso é deliberado — como chave primária, o teto faria um anúncio grátis da própria cidade subir acima de anúncios pagos da vizinha, que é exatamente o que a regra de peso proíbe. A cidade de origem nunca é limitada, e o teto é regra de distribuição, não de truncamento: o excedente só perde a vaga quando existe candidato de outra cidade para ocupá-la, de modo que uma cidade pequena com um vizinho grande continua entregando a página cheia. _Refina v2.0 §35: a diversidade entre vendedores continua adiada (ADI-02), mas a diversidade entre CIDADES passa a existir, com este limite._

_Conflito: DEC-07 e v2.0 §32 estabelecem que, entre anúncios de mesmo peso, a ordem é por distância crescente; o teto de DEC-29, agindo dentro da faixa, adia um anúncio mais próximo de uma cidade externa em favor de um mais distante de outra cidade. Vale DEC-29 nesse ponto: ela **delimita** a cláusula de distância de DEC-07 dentro da faixa, e `V3-INV-047` passa a valer ressalvado esse adiamento. A precedência do peso comercial não é tocada — entre faixas, DEC-07 continua íntegra e o teto nunca opera como chave primária._
...
**Proveniência:** ADI-02 · DEC-07 · DEC-29 · v2.0 §28 · v2.0 §29 · v2.0 §30 · v2.0 §31 · v2.0 §32 · v2.0 §33 · v2.0 §34 · v2.0 §35 · v2.0 §36 · v2.0 §38.
...
**Instrução E2.** Não está materializado entre as fontes normativas vigentes; relatórios de implementação F2 não integram as fontes normativas desta especificação (MET-01). `pendente`.
...
**Adiamento pelo teto de participação.** O excedente que o teto adia (seção 12) não sai do conjunto: desce para as páginas seguintes, na mesma faixa de peso e preservando a ordem relativa entre os demais anúncios (DEC-29). O adiamento é determinístico e faz parte da ordenação completa feita antes de `LIMIT`/`OFFSET`, de modo que nenhum anúncio é repetido nem perdido entre páginas, e a página seguinte não reabre a vaga que o teto já resolveu.
...
**Valores numéricos.** Nenhum TTL, tamanho de cache ou limite numérico entra aqui: não há fonte normativa que os fixe. O gate §5 (evidência) descreve um desenho de cache com TTLs distintos para liquidez e relaxações, mas por ser evidência não cria norma, e a instrução E4, que poderia fixá-los, não está materializada entre as fontes normativas vigentes. Valores iniciais: `pendente`.
...
Um único evento `search.executed`, com o payload mínimo de contexto da busca, é suficiente na fase atual. _Delimitação por ADI-01: a lista granular de eventos da v2.0 §44 — início da busca, intenção resolvida, escopo resolvido, raio automático escolhido, raio expandido, raio manual, zero resultados, resultados servidos, clique no resultado, visualização do veículo, lead criado, clique de WhatsApp — entra em fase posterior. Não é conflito: é adiamento._

`search.executed` é evento **de busca**: representa uma execução de busca, não um resultado individual. O payload deve conter, no mínimo, as grandezas definidas no nível da busca: consulta, modelo comercial, especificidade, cidade de origem, fonte da localização, modo geográfico, raio solicitado, raio efetivo, contagem de resultados, contagem de vendedores e versão de política. A lista define a semântica; os nomes concretos das chaves podem seguir o contrato existente. Após DEC-27, o "payload de contexto completo" de ADI-01 significa esse conjunto mínimo **search-scoped** (`V3-INV-052`); não significa a transposição integral do vocabulário de 14 grandezas da v2.0 §44.

_Conflito: a v2.0 §44 lista um único vocabulário de contexto — consulta, modelo comercial, especificidade, cidade de origem, fonte da localização, modo geográfico, raio solicitado, raio efetivo, contagem de resultados, contagem de vendedores, peso comercial, distância, posição e versão de política — compartilhado por eventos de granularidades diferentes, vários deles ligados a resultados, e não à busca como um todo (resultados servidos, clique no resultado, visualização do veículo, lead criado, clique de WhatsApp). Esta seção havia transportado a lista integralmente para `search.executed`, que é por busca, sem que nenhuma fonte dissesse de qual resultado extrair peso comercial, distância e posição. Vale DEC-27: esses três campos não fazem parte do payload mínimo de `search.executed` e só podem pertencer a contratos futuros explicitamente result-scoped. A correção é de granularidade, não de alcance: nenhuma grandeza de busca sai do payload._

**Modelo comercial** é o modelo comercial estruturado do SearchContext — o de uma busca estruturada ou o resolvido deterministicamente a partir do texto —, e é nulo quando a busca não tem modelo comercial. Nunca é a descrição FIPE, a versão, nem o modelo do primeiro anúncio retornado.

**Contagem de vendedores** (`seller_count`) é a quantidade de vendedores/anunciantes distintos — `COUNT(DISTINCT advertiser_id)` ou equivalente semântico — no mesmo `CandidateScope` e no mesmo território efetivo usados pela contagem de resultados (`result_count`), com os mesmos filtros, o mesmo SearchContext e a mesma elegibilidade, antes da paginação e sem ponderação comercial. Não é a contagem apenas dos vendedores da página atual e não é derivada da Guided Relaxation.

**Campos por resultado.** Peso comercial, distância e posição pertencem somente a eventos futuros que identifiquem explicitamente **um resultado individual dentro de um SearchContext** (por exemplo, um evento de interação com um resultado de busca ou uma futura impressão por resultado), adiados por ADI-01. Quando existirem: a posição é a posição 1-based daquele resultado na lista efetivamente apresentada naquele SearchContext; o peso comercial é o peso efetivo daquele anúncio naquele SearchContext, conforme a regra de ranking vigente (seção 12); a distância é a daquele anúncio à origem efetiva daquele SearchContext, conforme a semântica geográfica vigente (`V3-INV-034`). Em `search.executed`, nenhum dos três é substituído por média, mediana, máximo, mínimo ou valor do primeiro resultado sem nova decisão normativa, e nenhuma posição 1 artificial é emitida por se ter escolhido o primeiro resultado.

**Eventos granulares nesta fase.** DEC-27 não exige a criação de novos eventos result-scoped na fase atual. O único evento obrigatório continua sendo `search.executed`, nos termos de ADI-01 e `V3-INV-052`. A eventual introdução de eventos result-scoped será objeto de contrato próprio posterior.

O raio efetivo já consta dessa lista de contexto: o payload deve registrar o raio efetivo usado na busca. O `required_distance_km` é grandeza distinta do raio efetivo (seção 6), mas DEC-20 estabelece a distinção semântica e **não** o torna obrigatório na telemetria; nenhuma fonte normativa vigente o exige no payload.

O gatilho de revisão dos alvos de liquidez depende dessa telemetria (seção 6).

**Proveniência:** ADI-01 · DEC-17 · DEC-20 · DEC-27 · v2.0 §44.

---

## 17. Copy territorial e UX de expansão

O texto da página deve refletir a realidade do conjunto exibido. Em `EXACT_CITY`, o texto nomeia apenas a cidade e não deve dizer "e região". O mesmo vale quando o modo é automático e o raio declarado é 0: com o conjunto todo na própria cidade, o texto nomeia apenas a cidade, ainda que o território consultado tenha sido o piso regional. O copy segue o declarado, nunca o consultado — prometer "e região" numa página sem nenhum resultado de vizinho seria a falsidade que DEC-29 quis eliminar, invertida. Com raio declarado maior que 0, o texto deve declarar o raio — obrigação de DEC-03 — e, em busca de produto, deve dizer em até quantos quilômetros de qual origem os resultados foram encontrados. O texto pode informar quantos resultados foram encontrados, desde que a contagem reflita o conjunto efetivamente exibido.

**Distância por resultado e lista única (DEC-28).** Quando o raio declarado é maior que 0, cada resultado deve exibir a distância até a origem, para que o usuário saiba o que está olhando sem precisar abrir o anúncio. Os resultados formam **lista única**: separar os da origem dos das vizinhas em blocos rebaixaria um Destaque vizinho para baixo de um anúncio grátis local, que é o que DEC-07 proíbe. Resultados obtidos por concessão que o usuário aceitou podem aparecer em bloco próprio e rotulado (seção 9), porque aí a ampliação foi pedida.

**Contagens exibidas (DEC-29).** Toda contagem que a página mostrar — total de resultados, contadores de filtro e faceta — deve vir do mesmo conjunto que a página mostra, no mesmo território. Contagem de escopo diferente do grid é proibida mesmo quando é mais favorável.
...
**Proveniência:** DEC-03 · DEC-05 · DEC-19 · DEC-24 · DEC-28 · DEC-29 · v2.0 §49 · v2.0 §50 · v2.0 §52.
...
**Contagem em metadados (DEC-29).** Número de veículos em título, descrição, dados estruturados ou qualquer outro metadado de SEO deve ser o do mesmo conjunto que a página exibe. Com o piso regional, o estoque da cidade e o conjunto exibido deixaram de coincidir, e anunciar o número da cidade num metadado de página regional — ou o contrário — descreve uma página que não existe. O limiar de **indexação** continua contando apenas o estoque próprio (seção 1): o que muda aqui é o número exibido, não a decisão de indexar.
...
**Proveniência:** DEC-19 · DEC-24 · DEC-29 · v2.0 §51 · v2.0 §53 · v2.0 §54.
...
**Disposição (DEC-25).** **Superada por DEC-21**, que exige a menor concessão útil real, com arredondamento amigável configurável que continue incluindo o candidato que a justificou, e proíbe aplicar percentual ou degrau fixo quando o estoque permite concessão menor. DEC-26 fixou o quantum configurável dessa dimensão em R$ 1.000 — o mesmo número que aparecia na fórmula do gate, agora como quantum de arredondamento sobre o boundary real, e não como degrau de +15%.
**Onde entra:** seção 9.
...
Estas instruções pertencem à aprovação do gate da F2 e à mensagem "SQL OK". DEC-25 dispôs das oito propostas do gate uma a uma, por não haver aprovação em bloco materializada entre as fontes normativas; o texto das instruções A e E1–E4 também não está materializado entre elas. O `pendente` abaixo é, portanto, ausência de fonte normativa, não espera de um documento cuja existência esta especificação possa afirmar.

### Instrução A — cache

Não está materializado entre as fontes normativas vigentes; relatórios de implementação F2 não integram as fontes normativas desta especificação (MET-01). O gate §5 (evidência) contém um desenho de cache endereçado à instrução A, mas evidência não cria norma e o texto da instrução não está disponível. `pendente`.

### Instrução E1

Não está materializado entre as fontes normativas vigentes; relatórios de implementação F2 não integram as fontes normativas desta especificação (MET-01). `pendente`.
...
Não está materializado entre as fontes normativas vigentes; relatórios de implementação F2 não integram as fontes normativas desta especificação (MET-01). Os valores numéricos de cache que dependeriam dela permanecem `pendente` na seção 15.
...
**Liquidity Quality Score (v2.0 §21).** Em escala, quantidade sozinha não basta: doze anúncios de uma loja não têm a mesma qualidade que doze de seis vendedores. O avaliador de liquidez pode evoluir para considerar número de vendedores, diversidade de versões e de preço, qualidade e recência, descontando duplicidade e concentração. A v2.0 prevê que o contrato permaneça capaz de suportar essa evolução sem reescrita.
...
**Motor adaptativo por dados (v2.0 §45).** Com volume suficiente, o raio automático pode considerar comportamento real por categoria, alterando parâmetros do resolvedor de escopo, não a arquitetura. A v2.0 recomenda não adotar aprendizado de máquina antes de haver volume suficiente.
...
**Score de liquidez v2 (v2.0 §57).** Uma combinação ponderada de contagem, vendedores únicos, diversidade de preço e de versão e recência, descontando concentração de duplicados. A v2.0 orienta não fixar os pesos agora; o valor arquitetural é o avaliador substituível e versionado.
...
| v2.0                                                        | Situação na v3                                                                                                                                                                                                                                                                                                                                                                                                                           |
| ----------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| §59 A — cidade pura mostra só a própria cidade              | _Conflito: §59 A espera a página abrir somente com a cidade; DEC-03 faz a página nascer em `AUTO_RADIUS`. Vale DEC-03._ O cenário passa a esperar o menor território útil a partir do piso regional (DEC-29), com raio **declarado** 0 km apenas quando o conjunto final está todo na própria cidade, e declaração do raio quando maior que 0                                                                                            |
...
| §59 I — poucos resultados até 150 km não vira nacional      | Mantido quanto a não virar nacional; o caminho até 150 km deixa de ser automático: passa a depender de concessão aceita ou de raio manual explícito (DEC-11, DEC-24)                                                                                                                                                                                                                                                                     |
...
| V3-INV-005 | O automático escolhe o menor anel permitido que atinge o alvo **a partir do piso regional e do baseline de descoberta**, nunca abaixo deles                                                                                                                                                                                          | DEC-04 · DEC-28 · DEC-29   |
| V3-INV-006 | Um raio manual válido de N km, com N entre 1 e 150, permanece exatamente N, sem arredondar para anel                                                                                                                                                                                                                                 | DEC-19 · DEC-24            |
| V3-INV-007 | `required_distance_km` e `effective_radius_km` são grandezas semanticamente distintas                                                                                                                                                                                                                                                | DEC-20                     |
| V3-INV-008 | Cidade de outra UF entra se `distance_km` couber no raio do território consultado                                                                                                                                                                                                                                                    | DEC-06                     |
| V3-INV-009 | Filtro explícito de produto não amplia o território além do teto automático do próprio perfil                                                                                                                                                                                                                                        | DEC-10 · DEC-28            |
| V3-INV-010 | O motor nunca alcança 150 km por automação; 150 km só entra por raio manual explícito ou por concessão aceita                                                                                                                                                                                                                        | DEC-11 · DEC-24            |
| V3-INV-011 | Nenhuma concessão de Guided Relaxation é aplicada sem ação explícita do usuário                                                                                                                                                                                                                                                      | DEC-21                     |
| V3-INV-012 | Concessão com delta conhecido igual a zero não é apresentada; o limiar de oferta é de pelo menos um resultado acrescentado                                                                                                                                                                                                           | DEC-14 · DEC-21 · DEC-26   |
| V3-INV-013 | A menor concessão útil é dirigida pelo boundary real do estoque; nenhum percentual ou degrau fixo é aplicado quando o boundary pode ser calculado                                                                                                                                                                                    | DEC-21 · DEC-26            |
...
| V3-INV-029 | **RETIRADO por DEC-25** — a proposta do gate D1 não foi ratificada. A regra ativa é apenas: uma origem sem marcador de procedência não pode ser presumida `USER_SELECTED`; o fallback exato permanece PENDENTE antes da F3. ID reservado, não reutilizável.                                                                          | DEC-25 · `pendente`        |
| V3-INV-030 | O texto livre não move a origem por casamento de substring dentro de outra palavra                                                                                                                                                                                                                                                   | DEC-25                     |
| V3-INV-031 | **RETIRADO por DEC-25** — a divisão da correção entre caminho novo e legado é estratégia de compatibilidade/implementação, não invariante da Search Policy. O comportamento de fronteira de palavra continua coberto por V3-INV-030. ID reservado, não reutilizável.                                                                 | ADI-03 · DEC-25            |
...
| V3-INV-039 | Os alvos iniciais são 20/16/16/24/16/12 para os seis perfis nomeados                                                                                                                                                                                                                                                                 | DEC-17 · DEC-28            |
| V3-INV-040 | **RETIRADO por DEC-25** — a regra específica de D5 sobre teto automático por perfil não permanece como norma. O baseline automático 0/25/50/75 de `/comprar` é coberto por V3-INV-068, e a proibição de qualquer perfil chegar automaticamente a 150 km é coberta por V3-INV-010. ID reservado, não reutilizável.                    | DEC-25                     |
...
| V3-INV-047 | Entre anúncios de mesmo peso, a ordem é por distância crescente, ressalvado o adiamento do teto de participação por cidade (`V3-INV-083`)                                                                                                                                                                                            | DEC-07 · v2.0 §32          |
...
| V3-INV-052 | Na fase atual, `search.executed` é o único evento obrigatório de telemetria e seu payload de contexto da busca deve conter: consulta, modelo comercial, especificidade, cidade de origem, fonte da localização, modo geográfico, raio solicitado, raio efetivo, contagem de resultados, contagem de vendedores e versão de política. | ADI-01 · DEC-27            |
| V3-INV-053 | O payload de `search.executed` registra o `effective_radius_km` publicado, que descreve o conjunto final                                                                                                                                                                                                                             | ADI-01 · DEC-28 · v2.0 §44 |
...
| V3-INV-059 | Uma cidade sem página não ganha rota territorial por ser usada como origem de busca                                                                                                                                                                                                                                                  | DEC-01 · DEC-02            |
| V3-INV-060 | Relaxar preço, ano, câmbio, quilometragem ou distância preserva o mesmo produto                                                                                                                                                                                                                                                      | DEC-12                     |
| V3-INV-061 | As relaxações são ordenadas por banda de custo primeiro, depois por benefício, depois pelos desempates de vendedores e cidades, e só então pela ordem de prioridade determinística                                                                                                                                                   | DEC-21 · DEC-26            |
| V3-INV-062 | Bandas de custo, quantums de arredondamento e ordem de desempate são configuração versionada de política, não lógica no frontend                                                                                                                                                                                                     | DEC-21 · DEC-26            |
| V3-INV-063 | A concessão parte do boundary real, arredonda para cima e continua incluindo o candidato que a justificou; o valor aplicado, o da URL, o exibido e o que classifica a banda de custo são o mesmo                                                                                                                                     | DEC-21 · DEC-26 · v2.0 §52 |
...
| V3-INV-066 | A relaxação de distância usa a menor distância real que acrescenta resultados acima do território consultado, arredondada para cima ao quantum e limitada a 150 km, aplicada como raio manual e nunca reintroduzida no automático                                                                                                    | DEC-21 · DEC-26 · DEC-29   |
...
| V3-INV-079 | O território automático é o maior entre piso regional, território-base e território do perfil de produto                                                                                                                                                                                                                             | DEC-28                     |
| V3-INV-080 | O território do perfil de produto é calculado sobre a liquidez já filtrada pelas dimensões ativas                                                                                                                                                                                                                                    | DEC-28                     |
| V3-INV-081 | O `effective_radius_km` publicado é o menor anel que contém o conjunto final, nunca o território consultado                                                                                                                                                                                                                          | DEC-28 · DEC-23            |
| V3-INV-082 | Todo território automático parte do piso regional, mesmo com liquidez local suficiente                                                                                                                                                                                                                                               | DEC-29                     |
| V3-INV-083 | Dentro de uma faixa de peso, nenhuma cidade diferente da origem ocupa mais que o teto — fração da capacidade da faixa, que é o menor entre o tamanho da página e os candidatos da faixa — enquanto houver candidato de outra cidade na mesma faixa para a vaga                                                                       | DEC-29                     |
| V3-INV-084 | O teto nunca encurta a página: sem candidato de outra cidade na faixa, o excedente permanece e a vaga é preenchida                                                                                                                                                                                                                   | DEC-29                     |
| V3-INV-085 | A cidade de origem não é limitada pelo teto de participação                                                                                                                                                                                                                                                                          | DEC-29                     |
| V3-INV-086 | O teto de participação ordena depois do peso comercial, nunca antes                                                                                                                                                                                                                                                                  | DEC-29 · DEC-07            |
| V3-INV-087 | Com raio declarado maior que 0, cada resultado exibe a distância até a origem                                                                                                                                                                                                                                                        | DEC-28 · DEC-03            |
| V3-INV-088 | Os resultados formam lista única; não há bloco separado por cidade fora de concessão aceita                                                                                                                                                                                                                                          | DEC-28 · DEC-07            |
| V3-INV-089 | Toda contagem exibida, inclusive em metadados de SEO, vem do mesmo conjunto que a página mostra                                                                                                                                                                                                                                      | DEC-29                     |
| V3-INV-090 | A vizinhança do piso é recíproca: se B está dentro do piso de A, os anúncios de A entram na página de B, qualquer que seja o estoque de cada uma                                                                                                                                                                                     | DEC-29                     |

**Contagem.** IDs `V3-INV` alocados: **90**. Retirados: **3** — `V3-INV-029`, `V3-INV-031` e `V3-INV-040`. Invariantes normativos ativos: **87**. DEC-26 **não** criou invariante novo: refinou o enunciado e a proveniência de `V3-INV-012`, `V3-INV-013`, `V3-INV-061`, `V3-INV-062`, `V3-INV-063` e `V3-INV-066`, que continuam representando as mesmas obrigações sob os mesmos IDs, e por isso o total de ativos não mudou com ela. DEC-27 também **não** criou invariante novo. `V3-INV-052` preserva o mesmo ID porque continua governando o contrato mínimo do único evento obrigatório de telemetria; DEC-27 corrige quais grandezas pertencem semanticamente ao nível da busca, reduzindo esse mínimo de 14 para 11 grandezas, e reformula o enunciado e a proveniência do invariante. O total de ativos também não mudou com ela. DEC-28 e DEC-29 criam oito invariantes novos — `V3-INV-079` a `V3-INV-086` — e reformulam `V3-INV-009`, que preserva o ID porque continua governando a mesma obrigação (o limite da expansão dirigida por produto), agora medida contra o teto automático do perfil em vez de proibida por completo. `V3-INV-039` teve os alvos atualizados por DEC-28, sem mudar de obrigação. `V3-INV-047` e `V3-INV-008` preservam os IDs: o 047 ganhou a ressalva do teto de participação, que DEC-29 delimita dentro da faixa de peso, e o 008 passou a medir a inclusão contra o território consultado, em vez do `effective_radius_km` publicado, que DEC-28 redefiniu como descrição do conjunto final — nos dois casos a obrigação é a mesma, dita sem circularidade. `V3-INV-016` **não** mudou: ele governa a SEQUÊNCIA (território-base antes do produto), que DEC-18 mantém vigente e DEC-28 não toca; a obrigação de piso é de `V3-INV-079`, e uma sincronização anterior chegou a substituir uma pela outra, apagando a sequência — corrigido. A sincronização das normas de apresentação de DEC-28 e DEC-29 — distância por resultado, lista única e contagem exibida, inclusive em metadados de SEO — acrescenta `V3-INV-087`, `V3-INV-088` e `V3-INV-089`, que estavam no registro de decisões e não tinham invariante. A reciprocidade da vizinhança, que era premissa da DEC-29 sem requisito próprio, passa a ser `V3-INV-090`. Preservam os IDs, com enunciado sincronizado e sem obrigação nova: `V3-INV-005`, que DEC-28 delimita e DEC-29 supera no ponto do "menor território necessário" e que passa a declarar o piso e o baseline; `V3-INV-053`, que passa a nomear o `effective_radius_km` publicado, na redefinição de DEC-28; e `V3-INV-066`, cuja concessão de distância se mede contra o território consultado, não contra o declarado. Com isso, os IDs alocados passam a **90** e os ativos a **87**, mantidos os três retirados. Um ID retirado permanece reservado para rastreabilidade e nunca é reutilizado por outro requisito, do mesmo modo que a lacuna deliberada do DEC-16 no registro de decisões.
...
**Proveniência:** DEC-01 · DEC-02 · DEC-03 · DEC-04 · DEC-05 · DEC-06 · DEC-07 · DEC-08 · DEC-09 · DEC-10 · DEC-11 · DEC-12 · DEC-13 · DEC-14 · DEC-17 · DEC-18 · DEC-19 · DEC-20 · DEC-21 · DEC-22 · DEC-23 · DEC-24 · DEC-25 · DEC-26 · DEC-27 · DEC-28 · DEC-29 · ADI-01 · ADI-02 · ADI-03 · v2.0 §2.2 · v2.0 §2.3 · v2.0 §5 · v2.0 §6 · v2.0 §9 · v2.0 §11 · v2.0 §13 · v2.0 §18 · v2.0 §23 · v2.0 §26 · v2.0 §28 · v2.0 §29 · v2.0 §32 · v2.0 §33 · v2.0 §37 · v2.0 §38 · v2.0 §40 · v2.0 §41 · v2.0 §43 · v2.0 §46 · v2.0 §50 · v2.0 §52 · v2.0 §53 · v2.0 §59 · v2.0 §60 · v2.0 §61 (não reproduzido) · v2.0 §62 · v2.0 §65 · v2.0 §66.
