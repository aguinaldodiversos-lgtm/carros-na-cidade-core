...
**Delta DEC-27:** NÃO CERTIFICADO — sincronizado em 2026-09-21 (granularidade da telemetria: seção 16 e `V3-INV-052`). É conteúdo normativo posterior ao baseline `6981b73d` e, pela governança registrada abaixo, constitui delta não certificado até que uma auditoria documental própria o cubra. Não altera as certificações MET-01 e DEC-26, que continuam valendo apenas para os baselines que certificaram.
