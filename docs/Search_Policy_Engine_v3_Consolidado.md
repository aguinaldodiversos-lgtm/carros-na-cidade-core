...
| V3-INV-040 | **RETIRADO por DEC-25** — a regra específica de D5 sobre teto automático por perfil não permanece como norma. O baseline automático 0/25/50/75 é coberto por V3-INV-068. ID reservado, não reutilizável.                                                             | DEC-25                     |
