...
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `tests/search-policy/` (10 arquivos: F2 = resolvedores 21, escopo/facetas/relaxações/chips/cache 27, integração em Postgres real 12, flag off 5, guard regional 4, política 7; F1 = 34) | ✅ **110**                                                                                                                                       | `SKIP_INTEGRATION_ADS=1 NODE_ENV=test DISABLE_REDIS=true PG_SSL_MODE=disable DATABASE_URL=…5434/carros_na_cidade_snapshot TEST_DATABASE_URL=… npx vitest run tests/search-policy`                                                                                                                       |
...
| Prettier (gate incremental)                                                                                                                                                             | ✅ 17 arquivos novos formatados; os arquivos legados tocados já estavam conformes; gate `node scripts/prettier-changed.mjs` verde (37 elegíveis) | `node scripts/prettier-changed.mjs`                                                                                                                                                                                                                                                                     |
