...
`CityInventoryStats.tsx:26-33` comenta: _"Página é `force-dynamic`, então reflete
o dia da renderização — sinal de frescor honesto."_ A intenção era boa, mas o
...
**A mesma variável alimenta os dois.** O comentário na página é explícito: _"O
...
objetivo for reduzir a rolagem _antes_ dos blocos SEO, **18 ou 24** são os
...
> cards para a página 2 e faz os blocos SEO aparecerem _mais cedo_. Com 24, o
