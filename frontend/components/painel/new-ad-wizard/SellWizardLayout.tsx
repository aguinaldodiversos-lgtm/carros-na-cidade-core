...
export default function SellWizardLayout({
  ...
  return (
    <main className="cnc-pb-bottomnav min-h-screen bg-cnc-bg">
      ...
      <div className="mx-auto max-w-[820px] px-4 pb-12 pt-6 sm:pt-8">
        {breadcrumb}
        {profileSlot}
        <section
          className="cnc-card-premium p-6 sm:p-8"
          data-testid="wizard-step-container"
          data-step={currentStep + 1}
        >
          <h1 className="text-[28px] font-extrabold tracking-[-0.04em] text-cnc-text-strong sm:text-[34px]">
            {title}
          </h1>
          <p className="mt-2 text-sm leading-7 text-cnc-muted sm:text-[15px]">{subtitle}</p>
