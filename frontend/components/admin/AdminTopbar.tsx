    ...
    <header className="sticky top-0 z-50 w-full bg-[#1a56db] shadow-md">
      <div className="mx-auto flex h-14 max-w-[1440px] items-center gap-6 px-5">
        <Link href="/admin" className="flex items-center gap-2 shrink-0 mr-4">
          <svg viewBox="0 0 24 24" className="h-7 w-7 text-white" fill="currentColor"><path d="M18.92 6.01C18.72 5.42 18.16 5 17.5 5h-11c-.66 0-1.21.42-1.42 1.01L3 12v8c0 .55.45 1 1 1h1c.55 0 1-.45 1-1v-1h12v1c0 .55.45 1 1 1h1c.55 0 1-.45 1-1v-8l-2.08-5.99zM6.5 16c-.83 0-1.5-.67-1.5-1.5S5.67 13 6.5 13s1.5.67 1.5 1.5S7.33 16 6.5 16zm11 0c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5zM5 11l1.5-4.5h11L19 11H5z"/></svg>
