      ...
      <div className="mt-5 grid gap-6 lg:grid-cols-[1.1fr_1fr]">
        <div className="grid gap-4 sm:grid-cols-2">
          <label className="block">
            <span className="mb-2 block text-sm font-bold text-[#2f3953]">
              Valor do veiculo (R$)
            </span>
            <input
              type="number"
        ...
        <div className="grid gap-4">
          <article className="rounded-xl border border-[#e1e5ef] bg-[#f8fbff] p-4">
            ...
            <p className="mt-1 text-2xl font-extrabold text-[#0e62d8]">
              {toCurrency(result.financedAmount)}
            </p>
          </article>
          <article className="rounded-xl border border-[#e1e5ef] bg-[#f8fbff] p-4">
            <p className="text-xs font-semibold uppercase tracking-wide text-[#5f6980]">
          ...
          <article className="rounded-xl border border-[#e1e5ef] bg-[#f8fbff] p-4">
            ...
            <p className="mt-1 text-2xl font-extrabold text-[#0e62d8]">
              {result.effectiveCost.toFixed(1)}%
            </p>
