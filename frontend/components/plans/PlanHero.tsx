  ...
  return (
    <section className="overflow-hidden rounded-2xl bg-[linear-gradient(125deg,#0c4fb2_0%,#1390eb_100%)] p-8 text-white shadow-[0_16px_34px_rgba(12,79,178,0.3)]">
      ...
      <p className="mt-3 max-w-3xl text-sm text-white/90 md:text-base">
        Particular e lojista entram com um fluxo claro: escolher o plano certo, liberar capacidade
        de publicação, ganhar prioridade de exibição e acompanhar tudo no painel.
      </p>
      ...
      <div className="mt-6 grid gap-3 sm:grid-cols-3">
        {[
          {
            title: "Entrada clara",
            desc: "Plano gratuito para começar e upgrade quando o volume pedir.",
          },
          {
            title: "Valor operacional",
            desc: "Mais limite, destaque e prioridade para acelerar giro de estoque.",
          },
          {
            title: "Ativação simples",
            desc: "Escolha o plano, entre no painel e acompanhe publicação e impulso.",
          },
        ].map((highlight) => (
          <article
            key={highlight.title}
