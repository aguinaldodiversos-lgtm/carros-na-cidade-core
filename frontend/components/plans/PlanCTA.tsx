  ...
  return (
    <section className="mt-8 rounded-2xl bg-[linear-gradient(120deg,#0f4db6_0%,#1381e3_100%)] p-6 text-white shadow-[0_14px_30px_rgba(14,98,216,0.3)]">
      ...
      <p className="mt-2 max-w-3xl text-sm text-white/90">
        Entre no painel, escolha o plano ideal para seu momento e use impulsionamento quando quiser
        acelerar visibilidade.
      </p>
      ...
      <div className="mt-4 grid gap-3 md:grid-cols-3">
        {[
          ...
          <div
            key={item}
            className="rounded-xl border border-white/20 bg-white/10 p-4 text-sm font-semibold text-white/95"
          >
            {item}
          </div>
        ))}
