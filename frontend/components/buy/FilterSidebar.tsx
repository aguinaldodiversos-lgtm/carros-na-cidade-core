...
function BrandIcon({ className }: IconProps) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M12 3l8 4v5c0 4.5-3.4 8.3-8 9-4.6-.7-8-4.5-8-9V7z" />
...
function KmIcon({ className }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M12 15l4-4" strokeLinecap="round" />
...
function FuelIcon({ className }: IconProps) {
  return (
    ...
    >
      ...
      <path
        d="M14 10h2.5a1.5 1.5 0 0 1 1.5 1.5V16a1.5 1.5 0 0 0 3 0V9l-2.5-2.5"
        strokeLinecap="round"
      />
      <path d="M7 8h5" />
    </svg>
...
function Eyebrow({ children, className }: { children: ReactNode; className?: string }) {
  return (
    <p
      className={`mb-3 text-[12px] font-semibold uppercase tracking-[0.07em] text-cnc-muted ${className ?? ""}`}
    >
      {children}
    </p>
  );
...
function SelectField({
  ...
  return (
    <div className="space-y-2">
      <label
        htmlFor={id}
        className="block text-[12px] font-semibold uppercase tracking-[0.07em] text-cnc-muted"
      >
        {label}
      </label>
...
export function FilterSidebar({
  ...
  const chipOn =
    "border-primary bg-primary-soft text-primary shadow-[inset_0_0_0_1px_var(--tw-shadow-color)] shadow-primary";
    ...
    () =>
      TRANSMISSION_TYPES.map((opt) => {
        ...
        return total === undefined
          ? opt
          : { ...opt, label: `${opt.label} (${formatTotal(total)})` };
      }),
          ...
          <section aria-labelledby="filter-ofertas">
            ...
            <div className="flex flex-wrap gap-2.5">
              <button
                ...
                onClick={() =>
                  onPatch({ priority_tier: filters.priority_tier === 4 ? undefined : 4, page: 1 })
                }
              ...
              <button
                ...
                onClick={() =>
                  onPatch({ opportunity: filters.opportunity === true ? undefined : true, page: 1 })
                }
              ...
              <button
                ...
                onClick={() =>
                  onPatch({ below_fipe: filters.below_fipe === true ? undefined : true, page: 1 })
                }
          ...
          <section className="space-y-4" aria-labelledby="filter-localizacao">
            ...
            {showDistance ? (
              <div className="relative overflow-hidden rounded-2xl border border-primary/20 bg-gradient-to-br from-[#f1f5ff] via-[#e7eeff] to-[#e1eaff] px-5 pb-5 pt-5">
                <svg
                  className="pointer-events-none absolute bottom-0 right-0 top-0 w-[58%] opacity-55"
                  viewBox="0 0 220 200"
                  fill="none"
                  aria-hidden="true"
                >
                  ...
                  />
                  <path
                    d="M60 150 C110 130 150 160 205 150"
                    stroke="#9db4ea"
                    strokeWidth="1.5"
                    strokeDasharray="4 5"
                    opacity=".5"
                  />
                  <path
                    d="M130 88a11 11 0 0 1 11 11c0 8-11 18-11 18s-11-10-11-18a11 11 0 0 1 11-11z"
                    fill="#0e62d8"
                  />
                ...
                <div className="relative z-[1] mb-5 flex items-start gap-3.5">
                  ...
                  <div>
                    <h3 className="mb-1 text-[18px] font-bold text-cnc-text-strong">
                      Raio de busca
                    </h3>
