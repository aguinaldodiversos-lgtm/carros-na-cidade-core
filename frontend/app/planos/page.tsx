    ...
    <>
      ...
      <main className="mx-auto w-full max-w-7xl px-4 py-6 sm:px-6 sm:py-8">
        ...
        <section className="mt-8">
          <h2 className="text-[28px] font-extrabold leading-tight text-[#1d2538] sm:text-3xl">Planos para particulares</h2>
        ...
        <section className="mt-8">
          <h2 className="text-[28px] font-extrabold leading-tight text-[#1d2538] sm:text-3xl">Planos para lojistas</h2>
          <p className="mt-1 text-sm text-[#5f6982]">
        ...
        <section className="mt-8 rounded-2xl border border-[#dfe4ef] bg-white p-5 shadow-[0_2px_16px_rgba(10,20,40,0.05)]">
          <h2 className="text-2xl font-extrabold text-[#1d2538]">Como funciona a cobranca via Mercado Pago</h2>
          <div className="mt-4 grid gap-4 md:grid-cols-2">
            ...
            <article className="rounded-xl border border-[#e1e5ef] bg-[#f8fafe] p-4">
              <h3 className="text-base font-extrabold text-[#1e2b45]">Planos de Loja (recorrentes)</h3>
              <ul className="mt-2 space-y-1 text-sm text-[#4d5872]">
