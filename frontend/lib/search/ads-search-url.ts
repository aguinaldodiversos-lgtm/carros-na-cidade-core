...
export function parseAdsSearchFiltersFromSearchParams(
  ...
  return {
    ...
    price_min: toNumber(searchParams.get("price_min")) ?? toNumber(searchParams.get("min_price")),
    price_max: toNumber(searchParams.get("price_max")) ?? toNumber(searchParams.get("max_price")),
    year_min: toNumber(searchParams.get("year_min")),
    year_max: toNumber(searchParams.get("year_max")),
    mileage_min: toNumber(searchParams.get("mileage_min")),
